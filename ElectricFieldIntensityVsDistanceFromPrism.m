...
% Having the paper(DOI: 10.1016/j.sna.2010.02.005)(authors: Atef Shalabney, Ibrahim Abdulhalim) will help in deciphering the code for some symbols are matching.
...
%}
zstart=0.5e-9; % smallest value of z
zend=2*sum(d); % greatest value of z
zincr=0.5e-9; % increment in z; also, improvement: automate to set based on the precision of medium thickness
